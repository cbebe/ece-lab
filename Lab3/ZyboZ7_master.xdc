...
##Switches
#set_property -dict { PACKAGE_PIN G15    IOSTANDARD LVCMOS33 } [ get_ports { entered_input }];
set_property -dict { PACKAGE_PIN P15    IOSTANDARD LVCMOS33 } [ get_ports { input_sw[0] }];
set_property -dict { PACKAGE_PIN W13    IOSTANDARD LVCMOS33 } [ get_ports { input_sw[1] }]; #IO_L4N_T0_34 Sch=sw[2]
set_property -dict { PACKAGE_PIN T16    IOSTANDARD LVCMOS33 } [ get_ports { input_sw[2] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
...
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports { entered_input }]; #IO_L10P_T1_AD11P_35 Sch=btn[2]
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [ get_ports { rst_button }]; #IO_L7P_T1_34 Sch=btn[3]


##LEDs
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports { OPcode_LED[0] }];
set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS33} [get_ports { OPcode_LED[1] }];
set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports { OPcode_LED[2] }];
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports { OPcode_LED[3] }];
...
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33     } [get_ports { display_sum[0] }]; #IO_L8N_T1_34 Sch=jc_n[3]
#set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33     } [get_ports { display_sum[1] }]; #IO_L2P_T0_34 Sch=jc_p[4]
#set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33     } [get_ports { display_sum[2] }]; #IO_L2N_T0_34 Sch=jc_n[4]
