...
int main(void) {
	xTaskCreate(TaskLoopCountProcessor, (const char *) "Loop_Count_Manager",
	configMINIMAL_STACK_SIZE * 5,
	NULL,
	tskIDLE_PRIORITY + 1, &xTask_loop_count_processor_task_handle);

	xTaskCreate(TaskPrintRunTimeStats, (const char *) "Stats",
	configMINIMAL_STACK_SIZE * 5,
	NULL,
	tskIDLE_PRIORITY + 1, &xTask_print_run_time_stats_task_handle);

	xTaskCreate(TaskCpuLoadGen, (const char *) "Load_Gen",
	configMINIMAL_STACK_SIZE * 5,
	NULL,
	tskIDLE_PRIORITY, &xTask_cpuload);
